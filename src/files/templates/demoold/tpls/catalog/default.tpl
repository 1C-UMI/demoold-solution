...
%catalog getSmartCatalog('default', '%category_id%')%
...
<table style="width: 100%;">
	<tr>
		<td>
			%catalog getSmartFilters('new_search', '%category_id%', 0, 0)%
		</td>
	</tr>
</table>
<br />
...
<div itemscope="itemscope" itemtype="http://schema.org/Product">
	<link itemprop="name" content="%name%" />
	%vote getElementRating('default', %pid%)%
