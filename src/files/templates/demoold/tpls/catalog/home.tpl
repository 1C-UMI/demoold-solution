...
$FORMS['view_block'] = <<<END
					<div class="item">
						...
						<table border="0">
							<tr>
								...
								<td style="padding-left: 8px; vertical-align:top;">
									<a href="%link%" class="title" umi:element-id="%id%" umi:field-name="name">%name%</a>
						...
						%emarket basketAddLink(%id%)% <a href="%link%#comments" >Комментарии (%comments countComments(%id%)%)</a>
					</div>
