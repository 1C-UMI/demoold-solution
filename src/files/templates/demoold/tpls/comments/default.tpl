...
<div itemprop="review" itemscope itemtype="http://schema.org/Review">
	...
	<p>
		<b class="s_num">%num%.</b>
		<b umi:element-id="%id%" umi:field-name="name" umi:delete="delete">%title%</b> - 
		<span itemprop="author">%users viewAuthor(%author_id%)%</span>
		<br />
		<i itemprop="datePublished">%system convertDate(%publish_time%, 'Y-m-d в H:i')%</i>
	</p>
	<div umi:element-id="%id%" umi:field-name="message" umi:delete="delete" itemprop="description">%message%</div>
</div>
COMMENT_LINE_USER;
