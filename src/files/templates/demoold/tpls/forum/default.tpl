...
<script type="text/javascript">
	if(!jQuery("form[action^='/forum/message_post']").get(0)) {
		jQuery(".quo").css('display', 'none');
	}
</script>
...
<tr>
	<td>
		...
		<div style="padding: 10px 0;" class="quo">
			(<a href="#add" onmousedown="javascript: forum_quote(%id%); return false;" onfocus="javascript: return false;">Цитировать</a>)
		</div>
		<br />
	</td>
</tr>
